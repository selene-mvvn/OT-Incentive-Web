    ...
    with col_main:
        ...
        with st.container():
            ...
            if len(st.session_state['ot_records']) > 0:
                ...
                <hr class="custom-hr-divider" style="margin: 4px 0 4px 0 !important; border: 0; border-top: 1px solid rgba(0, 176, 240, 0.2) !important;">
                """, unsafe_allow_html=True)
                st.markdown(
                ...
                <div id="ot-table-bottom-divider" style="margin: 8px 0 10px 0; border-top: 1px solid rgba(0, 176, 240, 0.2) !important;"></div>
                """, unsafe_allow_html=True)
