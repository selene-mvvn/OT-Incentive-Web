        ...
        with st.container():
            ...
            with tab_auto:
                ...
                if total_hours_auto > 0:
                    ...
                    with b_col1: st.metric("150%", fmt_h(auto_buckets[150]), help=f"{nt}: 17h-22h")
                    with b_col2: st.metric("200%", fmt_h(auto_buckets[200]), help=f"{nt}: 22h-24h\n{ct}: 08h-22h")
                    with b_col3: st.metric("270%", fmt_h(auto_buckets[270]), help=f"{ct}: 22h-24h")
                    with b_col4: st.metric("300%", fmt_h(auto_buckets[300]), help=f"{nl}: 17h-22h")
                    with b_col5: st.metric("400%", fmt_h(auto_buckets[400]), help=f"{nl}: 08h-17h")
