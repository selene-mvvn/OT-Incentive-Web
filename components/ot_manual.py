        ...
        with col_left:
            ...
            <div id="gross-tooltip" style="position: relative; width: 100%; height: 0px; z-index: 999; pointer-events: none;">
                <div title="{t('Lưu ý: Cột Lương Gross sẽ được tính TỰ ĐỘNG khi bạn bấm Lưu.', '注:「総支給額」は保存時に自動計算されます。')}" 
                     style="position: absolute; right: 145px; top: 4px; pointer-events: auto; display: flex; align-items: center; justify-content: center; width: 22px; height: 22px; color: #838e9d; cursor: help; opacity: 0.8; transition: opacity 0.2s;">
