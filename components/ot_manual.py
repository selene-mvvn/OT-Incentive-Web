        ...
        with col_left:
            ...
            if deleted > 0:
                ...
                for idx in deleted_idx:
                    details.append(f"- :material/cancel: **{t('Đã xóa', '削除')}**: <span style='color: #9ca3af; text-decoration: line-through; text-decoration-color: black;'>{format_emp_row(display_df, idx)}</span>")
