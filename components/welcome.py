    ...
    st.markdown(f"""
        ...
        <div class="info-card">
            ...
            <div style="position: absolute; bottom: -35px; right: -30px; pointer-events: none;">
                <iframe srcdoc="<!DOCTYPE html><html><head><script src='https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js'></script><style>body {{ margin: 0; padding: 0; background: transparent; overflow: hidden; display: flex; justify-content: center; align-items: center; }}</style></head><body><lottie-player src='https://assets2.lottiefiles.com/packages/lf20_bpqri9y8.json' background='transparent' speed='1' style='width: 90px; height: 90px;' loop autoplay></lottie-player></body></html>" style="width: 100px; height: 100px; border: none; overflow: hidden; background: transparent; pointer-events: auto;"></iframe>
            </div>
        </div>
    """, unsafe_allow_html=True)
